...
<body>
    ...
    <div class="container">
        <div class="content-dashboard-container justify-content-center align-items-center mx-auto">
            ...
            <form action="{{ url('/shoulder_insert') }}" method="POST" enctype="multipart/form-data" class="modal-content">
                @csrf
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Add Shoulder Exercise</h1>
                ...
                <div class="modal-body">
                    ...
                    <input type="text" class="form-control" id="categories" name="categories" value="shoulder" readonly>
                    </div>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="modal fade" id="editModal{{$exercise->id}}" tabindex="-1" aria-labelledby="editModalLabel{{$exercise->id}}" aria-hidden="true">
                                <div class="modal-dialog">
                                    <form action="{{ url('/shoulder_update') }}" method="POST" enctype="multipart/form-data" class="modal-content">
                                        @csrf
                                        @method('PUT')
                                        <input type="hidden" name="id" value="{{ $exercise->id }}">
                                        <div class="modal-header">
                                            <h1 class="modal-title fs-5" id="editModalLabel{{$exercise->id}}">Edit Shoulder Exercise</h1>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body">
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="edit_updated_by" name="updated_by" value="{{ session('user_name') }}" readonly>
                                            </div>
                                            <div class="mb-3">
                            ...
                            {{-- Delete Button --}}
                            <form action="{{ url('/shoulder_delete') }}" method="POST" style="display:inline;">
                                @csrf
                                <input type="hidden" name="id" value="{{ $exercise->id }}">
